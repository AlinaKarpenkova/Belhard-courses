(function ($) {
    $(document).ready(function () {
        ...
        $('.lp-tabs').each(function () {
            ...
            // Устанавливаем значение футера по умолчанию
            $('.lp-tab-footer').append('Активная вкладка: ' + tabsTitlesNames[0] + ' (1/4)');
            
            
            // По клику на заголовке вкладки
            tabsTitlesItems.mouseenter('on', function () {
                ...
                if (!tabs.hasClass('changing')) {
                    ...
                    // Устанавливаем новое значение футера
                    $('.lp-tab-footer').append('Активная вкладка: ' + $(this).text() + ' (' + ($(this).index() + 1) + '/4)');
